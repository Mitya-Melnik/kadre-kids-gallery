            ...
            <Sheet open={isMenuOpen} onOpenChange={setIsMenuOpen}>
                  ...
                  <nav className="flex flex-col gap-1">
                    {menuItems.map((item, index) => (
                      <button
                        ...
                        className={`text-left p-3 rounded-lg hover:bg-accent/10 transition-colors text-xl font-medium ${
                    ...
                    <Button 
                      variant="default" 
                      className="mt-4 w-full py-4 text-xl font-semibold bg-primary hover:bg-primary/90"
              ...
              <SheetContent side="right" className="hidden sm:block w-96 bg-background/95 backdrop-blur-sm">
                <div className="flex flex-col gap-6 mt-6">
                  ...
                  <nav className="flex justify-center gap-12 flex-wrap">
                    {menuItems.map((item, index) => (
                      <button
                        key={index}
                        onClick={() => scrollToSection(item.href)}
                        className={`p-4 rounded-lg hover:bg-accent/10 transition-colors text-2xl font-medium ${
                          item.name === "Галерея" ? "text-accent" : "text-foreground hover:text-primary"
                        }`}
                      >
                        {item.name}
                  ...
                  <div className="flex justify-center items-center gap-8 mt-4">
                    ...
                    <Button 
                      variant="default" 
                      className="bg-primary hover:bg-primary/90 text-primary-foreground px-8 py-4 text-xl"
                      onClick={() => scrollToSection("#cta")}
                    >
                      Заказать съемку
                    </Button>
