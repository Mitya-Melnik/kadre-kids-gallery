...
const albumFaqs = [
  { question: "Какие выпускные альбомы можно заказать?", answer: "Для детского сада и школы доступны одинаковые форматы: альбом-папка, альбом-трио и альбомы на 6, 10 или 14 страниц. Комплектация и количество съёмочных дней зависят от выбранного варианта." },
