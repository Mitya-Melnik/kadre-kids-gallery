...
const FAQ = () => {
  ...
  const faqs = [
    ...
    },
    {
      ...
      answer: "Через наш Telegram-бот 24/7: текущий статус и поддержка в чате."
    },
    {
      question: "Когда будут готовы напечатанные фото?",
      answer: "Через 14 дней после оплаты мы привезём их в детский сад."
    },
    {
    ...
    },
    {
      ...
      answer: "Воспитатель пришлёт инструкцию в чат группы и мы продублируем в Telegram-бот."
    },
    {
      question: "Где взять ссылку на Telegram-бота?",
      answer: "ссылка на телеграмм бота https://t.me/DetiVkadre_bot"
    },
    {
