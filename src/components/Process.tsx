  ...
  const steps = audience === "school"
    ? baseSteps.map((step) => ({
        ...
        description: step.description
          ...
          .replace("Выбираем формат и комплектацию. Для группы готовим два полноценных дизайна — отдельно для мальчиков и девочек.", "Выбираем формат, комплектацию и один из 6 школьных дизайнов. Если нужно, можем подготовить два варианта для класса."),
      }))
    : baseSteps;
