...
const KindergartenAdvantages = () => {
  ...
  const advantages = [
    ...
    {
      icon: Clock,
      title: "Понятные условия и сроки",
      description: "Этапы, стоимость и сроки фиксируем в договоре до начала работы."
    },
    {
      icon: Gamepad2,
    ...
    },
    {
      ...
      description: "Сопровождаем ответственного родителя от выбора альбома до получения готового тиража."
    },
    {
      icon: Palette,
      title: "Естественная обработка",
      description: "Бережно обрабатываем фотографии, сохраняя мимику, внешность и характер ребёнка."
    },
    {
      icon: Camera,
      title: "Техника",
    ...
    },
    {
      ...
      description: "Заключаем договор и предоставляем комплект документов для детского сада."
    }
  ];
