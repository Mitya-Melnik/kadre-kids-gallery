...
const KindergartenAdvantages = ({ audience = "kindergarten" }: { audience?: "kindergarten" | "school" }) => {
  ...
  const schoolAdvantages = [
    ...
    {
      icon: ListChecks,
      title: "Минимум фотографий гарантирован",
      description: "Для каждого формата заранее устанавливаем минимальное количество разных фотографий выпускника и фиксируем его в договоре."
    },
    {
      icon: UserRoundPlus,
