...
const KindergartenHero = () => {
  ...
  const advantages = [
    ...
    {
      emoji: "✓",
      text: "<strong>Портрет ребёнка</strong><br/>выбираете вы"
    },
    {
      emoji: "📷",
      text: "<strong>Бесплатно доснимем</strong><br/>отсутствовавших детей"
    },
    {
      emoji: "📄",
      text: "<strong>Стоимость и сроки</strong><br/>фиксируем в договоре"
    }
  ];
