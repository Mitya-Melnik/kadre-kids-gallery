...
const FabContact = ({ aboveMobileBar = false }: FabContactProps) => {
  const [open, setOpen] = useState(false);

  return (
    <div className={`fixed right-4 z-50 flex flex-col items-end ${aboveMobileBar ? "bottom-24 md:bottom-6" : "bottom-6"}`}>
